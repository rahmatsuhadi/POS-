...
export function TopNav({
  ...
  return (
    <header className="pointer-events-none fixed inset-x-0 top-5 z-50 px-4 sm:px-6">
      <div
        className={`pointer-events-auto mx-auto flex items-center justify-between rounded-full border border-slate-200/80 bg-white/80 px-5 py-3 shadow-xl shadow-slate-900/5 backdrop-blur-xl transition-all duration-300 hover:border-slate-300 ${maxWidth} ${className}`}
      >
