    ...
    <>
      ...
      <section className="relative overflow-hidden border-t border-slate-200/80 bg-slate-50/80 py-32 text-center md:py-48">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6">
          <h2 className="mb-6 text-3xl leading-[1.08] font-extrabold tracking-tight text-slate-900 sm:text-5xl lg:text-6xl">Mulai layani pembeli pertamamu dalam waktu kurang dari 60 detik.</h2>
          <p className="mx-auto mb-10 max-w-2xl text-base leading-relaxed font-normal text-slate-600 sm:text-xl">Buka lewat browser HP atau laptop, atur nama tokomu, dan kasir langsung aktif. 100% gratis tanpa syarat kartu kredit.</p>

          <div className="flex flex-wrap items-center justify-center gap-4">
            <Link href="/onboarding" className="group inline-flex items-center justify-center gap-2.5 rounded-full bg-emerald-600 px-8 py-4 text-sm font-semibold text-white shadow-lg shadow-emerald-600/25 transition-all duration-300 hover:scale-[1.02] hover:bg-emerald-500 hover:shadow-emerald-600/40">
              <span>{isOnboarded ? "Atur Ulang Toko" : "Buka Kasir Sekarang — Gratis"}</span>
          ...
          <div className="mb-8 flex flex-wrap items-center justify-between gap-6 border-b border-slate-800 pb-8">
            <Link href="/" className="flex items-center gap-3">
              <div className="h-8 w-8 rounded-full border border-white p-[1px] shadow-lg">
                <div className="flex h-full w-full items-center justify-center rounded-full bg-slate-950 text-xs font-bold text-white">K</div>
              </div>
              <span className="text-base font-extrabold tracking-tight text-white">KalaPOS</span>
            </Link>
