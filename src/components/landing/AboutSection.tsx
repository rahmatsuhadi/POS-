      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-16">
          <div className="space-y-6 lg:col-span-6">
            <h2 className="text-3xl leading-[1.12] font-extrabold tracking-tight text-slate-900 sm:text-5xl">
              Dibuat untuk
              <span
            ...
            <p className="text-base leading-relaxed font-normal text-slate-600">
