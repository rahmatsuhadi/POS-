  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50/60 font-sans text-slate-900 selection:bg-emerald-500 selection:text-white">
      ...
      >
        ...
        <section
          ref={heroRef}
          className="relative flex flex-col items-center justify-center overflow-hidden border-b border-slate-200/80 bg-white py-20 md:py-32"
        >
          ...
          <div className="mx-auto w-full max-w-6xl px-4 text-center sm:px-6">
            ...
            <p className="hero-element mx-auto mb-8 max-w-2xl text-base leading-relaxed font-normal text-slate-600 sm:text-xl">
              Catat transaksi secepat kilat di HP, tablet, atau laptop. Kirim
              nota resmi ke{" "}
              <strong className="font-semibold text-slate-900">WhatsApp</strong>
              , cetak struk Bluetooth, dan auto-sync ke{" "}
              <strong className="font-semibold text-slate-900">Cloud</strong>{" "}
              begitu online. Tanpa biaya langganan bulanan.
            </p>
            ...
            <div className="hero-element mb-5 flex flex-wrap items-center justify-center gap-4">
              ...
              >
                <span>
                  {isOnboarded ? "Atur Ulang Toko" : "Mulai Jualan Gratis"}
                </span>
                <ArrowRight
                  size={16}
                  weight="bold"
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="mx-auto mb-16 max-w-3xl text-center">
              <h2 className="mb-4 text-2xl leading-tight font-extrabold tracking-tight text-slate-900 sm:text-4xl">
                Kasir modern seharusnya bikin jualan tenang, bukan bikin panik
                saat listrik padam.
              </h2>
              <p className="text-base leading-relaxed font-normal text-slate-600 sm:text-lg">
                Banyak aplikasi kasir mendadak macet saat sinyal drop, menagih
                sewa bulanan mahal, atau memaksa form inventori rumit padahal
                usahamu hanya menjual layanan jasa.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              <div className="space-y-3 rounded-3xl border border-slate-200/80 bg-slate-50 p-8">
                ...
                <p className="text-sm leading-relaxed text-slate-600">
                  Jualan di ruko semi-basement atau bazar outdoor sering
                  terkendala sinyal. KalaPOS mencatat transaksi langsung di
                  memori perangkat dengan respon &lt; 150 ms tanpa antrean
                  menumpuk.
                </p>
              </div>
              ...
              <div className="space-y-3 rounded-3xl border border-slate-200/80 bg-slate-50 p-8">
                ...
                <p className="text-sm leading-relaxed text-slate-600">
                  ...
                  ratusan ribu per bulan atau potongan komisi per transaksi.
                  Nikmati seluruh fitur kasir esensial secara gratis.
                </p>
              </div>
              ...
              <div className="space-y-3 rounded-3xl border border-slate-200/80 bg-slate-50 p-8">
                ...
                <p className="text-sm leading-relaxed text-slate-600">
                  Pangkas rambut, laundry, servis, dan fotografi tidak butuh
                  form stok gudang yang rumit. Cukup matikan saklar stok dengan
                  1 klik, dan kamu bisa langsung mulai jualan.
                </p>
              </div>
            </div>
          </div>
        ...
        >
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="mx-auto mb-16 max-w-3xl text-center">
              ...
              <p className="text-base leading-relaxed font-normal text-slate-600 sm:text-lg">
                Dirancang fleksibel untuk freelancer mandiri, toko kelontong,
                hingga barbershop dan kafe dengan banyak staf.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              ...
              <div className="group flex flex-col justify-between rounded-3xl border border-slate-200 bg-white p-8 shadow-sm transition-all duration-300 hover:border-emerald-500/50 hover:shadow-md">
                <div>
                  ...
                  <p className="text-sm leading-relaxed text-slate-600">
                    Pelacakan sisa stok berkurang otomatis saat terjual,
                    dukungan scan barcode via kamera HP, dan tombol uang pas
                    untuk melayani pembeli secepat kilat.
                  </p>
                </div>
              ...
              <div className="group flex flex-col justify-between rounded-3xl border border-slate-200 bg-white p-8 shadow-sm transition-all duration-300 hover:border-emerald-500/50 hover:shadow-md">
                <div>
                  ...
                  <p className="text-sm leading-relaxed text-slate-600">
                    ...
                    ditransaksikan tanpa batas kuota. Langsung bagikan nota
                    invoice resmi via WhatsApp pelanggan.
                  </p>
                </div>
              ...
              <div className="group flex flex-col justify-between rounded-3xl border border-slate-200 bg-white p-8 shadow-sm transition-all duration-300 hover:border-emerald-500/50 hover:shadow-md">
                <div>
                  ...
                  <p className="text-sm leading-relaxed text-slate-600">
                    Gabungkan produk fisik dan jasa dalam satu layar. Aktifkan
                    Mode Bisnis ber-PIN agar staf kasir tidak bisa mengintip
                    laporan profit dan pengaturan toko.
                  </p>
                </div>
